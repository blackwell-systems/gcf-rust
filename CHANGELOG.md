...
- Conformance runner support for `generic-pack-root`, `generic-delta`, `generic-delta-verify`, `generic-delta-decode` (12 shared fixtures); produces identical pack roots and delta wire to `gcf-go`, `gcf-python`, and `gcf-typescript`.
